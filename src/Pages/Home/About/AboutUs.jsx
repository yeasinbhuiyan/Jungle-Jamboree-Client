        ...
        return (
            <div className='grid grid-cols-1 md:grid-cols-2 p-10 md:p-1  gap-10 py-10 items-center mx-auto bg-base-200'>
                ...
                <div className='space-y-6 mx-auto'>
                    ...
                    <div>
                        <Link to='/about'> <button className='flex items-center border-2 border-transparent btn btn-outline btn-info border-cyan-300 rounded-full'>Read more <FaArrowRight className='ml-2'></FaArrowRight></button></Link>
                    </div>
                </div>
